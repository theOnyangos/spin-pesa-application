...
$(document).ready(function () {
	...
	var a =
			...
			graphs: [
				{
					...
					clustered: !1,
					columnWidth: 0.5,
					legendValueText: "KES [[value]]M",
					balloonText:
						"[[title]]<br /><b style='font-size: 130%'>KES [[value]]M</b>",
				},
				{
					id: "g4",
					valueAxis: "v1",
		...
		AmCharts.makeChart("proj-earning", {
			...
			dataProvider: [
				{ type: "Doc", visits: 10 },
				{ type: "Parcel", visits: 15 },
				{ type: "Box", visits: 12 },
				{ type: "Crate", visits: 16 },
				{ type: "Pallet", visits: 8 },
			],
			valueAxes: [
				{
					gridAlpha: 0.3,
